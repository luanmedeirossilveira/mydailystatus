    ...
    return (
        <div>
            ...
            <label className='block'>
                <input type='radio' name='status' value='bem' onClick={onStatusChange}></input>
                Estou bem e sem sintomas
            </label>
            <label className='block'>
                <input type='radio' name='status' value='gripe' onClick={onStatusChange}></input>
                Estou com sintomas de gripe / resfriado
            </label>
            <label className='block'>
                <input type='radio' name='status' value='covid' onClick={onStatusChange}></input>
                Estou com sintomas do COVID
            </label>
